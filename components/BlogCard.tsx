...
const BlogCard: React.FC<Props> = ({ post }) => {
  ...
  return (
    <li ref={sectionRef} className="my-4 md:mt-0 md:mb-8">
      <div className="overflow-hidden bg-white dark:bg-carddark rounded-2xl border border-marrsgreen dark:border-transparent shadow-lg shadow-[0_0_40px_12px_rgba(56,189,248,0.25)] transition-all duration-300 p-5">
